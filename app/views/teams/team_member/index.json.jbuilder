...
json.data @team_members do |team_member|
  ...
  json.links do
    json.tasks_url Rails.application.routes.url_helpers.team_member_tasks_url(team_member.team.id, team_member.id, host: request.host, protocol: request.protocol)
  end
end